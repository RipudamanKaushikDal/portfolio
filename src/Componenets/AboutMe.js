    ...
    return(
     <Grid container style={{height:'100vh',width:'100%'}} >
         ...
         <Grid container className={classes.rightContainer} xs={12} sm={12} md={5} lg={5}>
             <Grid item style={{color:'#f58c00',padding:'1rem'}}  >
                 <Typography variant="h2">Ripudaman <span style={{color:'#ffa329',margin:'0px', padding:'0 0.5rem 0.5rem 5rem'}}>Kaushik</span></Typography>
             </Grid>
             
             <Grid item style={{color:'whitesmoke',padding:'1rem'}} >
